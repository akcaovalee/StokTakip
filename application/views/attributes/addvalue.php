...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="<?php echo base_url('attributes/') ?>">Özellikler</a></li>
    </ol>
  </section>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Özelliği Barındıran Ürün Ekle</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/createValue') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="brand_name">Ürün Adı</label>
            <input type="text" class="form-control" id="attribute_value_name" name="attribute_value_name" placeholder="Ürün Adı" autocomplete="off">
          </div>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Ürün Adını Düzenle</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/updateValue') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Ürün Adı</label>
            <input type="text" class="form-control" id="edit_attribute_value_name" name="edit_attribute_value_name" placeholder="Ürün Adı" autocomplete="off">
          </div>
        </div>
